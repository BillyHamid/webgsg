import { _ as __nuxt_component_0 } from "./nuxt-link-B4UUcJgT.js";
import { a as _sfc_main$4, _ as _imports_0 } from "./_virtual_public-C0CzJPiQ.js";
import { defineComponent, computed, mergeProps, unref, useSSRContext, ref, toValue, reactive, watch, withAsyncContext, withCtx, createVNode, createTextVNode } from "vue";
import { ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderStyle, ssrRenderClass, ssrRenderComponent, ssrRenderAttr } from "vue/server-renderer";
import { _ as _export_sfc, d as useNuxtApp, f as fetchDefaults, j as useRuntimeConfig, h as useRoute } from "../server.mjs";
import { getRequestURL } from "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/h3@1.15.11/node_modules/h3/dist/index.mjs";
import { hash } from "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs";
import { u as useAsyncData } from "./asyncData-CCqAsD0a.js";
import "socket.io-client";
import "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs";
import { a as useSeoMeta } from "./v3-Dp-QybCP.js";
import "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/ufo@1.6.4/node_modules/ufo/dist/index.mjs";
import "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/defu@6.1.7/node_modules/defu/dist/defu.mjs";
import "#internal/nuxt/paths";
import "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs";
import "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs";
import "vue-router";
import "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs";
import "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/perfect-debounce@2.1.0/node_modules/perfect-debounce/dist/index.mjs";
import "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/@unhead+vue@2.1.16_vue@3.5.40_typescript@5.9.3_/node_modules/@unhead/vue/dist/index.mjs";
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const color = computed(() => COLORS[props.state] ?? "bg-slate-100 text-slate-700 ring-slate-200");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(__props.steps, (step, i) => {
        ...
        if (step.state === __props.currentState) {
          _push(`<span class="inline-flex items-center gap-1 text-[11px] font-bold uppercase tracking-wide text-accent-600 bg-accent-50 rounded-full px-2 py-0.5" data-v-1cc855ca><span class="size-1.5 rounded-full bg-accent-500 animate-pulse" data-v-1cc855ca></span> ${ssrInterpolate(__props.currentState === "delivered" ? "Livré" : "Étape actuelle")}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(` ${ssrInterpolate(unref(copied) ? "Copié !" : "Copier le lien")}</button></div>`);
    };
  }
});
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(data)) {
        _push(`<!--[--><p class="reveal reveal-1 text-xs font-medium text-ink-300 uppercase tracking-wider">Numéro de suivi</p><p class="reveal reveal-2 text-2xl sm:text-3xl font-display font-extrabold text-white font-mono tracking-tight mt-1">${ssrInterpolate(unref(data).trackingNumber)}</p><div class="reveal reveal-3 mt-4">`);
      ...
      if (unref(error)) {
        ...
        _push(`</div><h2 class="font-display text-lg font-bold text-ink-900">${ssrInterpolate(unref(error).statusCode === 404 ? "Numéro de suivi introuvable" : "Le suivi est momentanément indisponible")}</h2><p class="text-sm text-slate-500 mt-1.5 max-w-xs mx-auto"> Vérifiez le numéro et réessayez, ou contactez-nous au <a href="tel:+13473210379" class="text-accent-600 font-medium">+1 (347) 321-0379</a>. </p>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/",
        ...
        _push(`<div class="space-y-5"><section class="reveal reveal-3 bg-white rounded-3xl border border-ink-100 p-6 sm:p-8 shadow-xl shadow-black/5"><p class="tracking-kicker text-accent-600 mb-3">Votre envoi, étape par étape</p><h1 class="font-display text-3xl font-extrabold tracking-tight text-ink-900">${ssrInterpolate(unref(data).currentStateLabel)}</h1><p class="text-sm text-ink-500 mt-3">${ssrInterpolate(unref(data).currentState === "delivered" ? "Votre colis est arrivé au terme de son voyage." : unref(data).currentState === "cancelled" ? "Cet envoi a été annulé. Contactez votre agence pour plus d’informations." : "Retrouvez ci-dessous les dernières étapes enregistrées par notre équipe.")}</p>`);
        if (unref(data).currentState !== "cancelled") {
          _push(`<!--[--><div class="flex justify-between text-xs text-ink-500 mt-6 mb-3"><span>Progression du parcours</span><span>${ssrInterpolate(unref(completed))} / ${ssrInterpolate(unref(totalSteps))} étapes</span></div><div role="progressbar" aria-label="Étapes réalisées"${ssrRenderAttr("aria-valuenow", unref(completed))}${ssrRenderAttr("aria-valuemax", unref(totalSteps))}${ssrRenderAttr("aria-valuemin", 0)} class="h-2 rounded-full bg-ink-50 overflow-hidden"><div class="h-full bg-accent-500 rounded-full transition-all duration-700" style="${ssrRenderStyle({ width: unref(progress) + "%" })}"></div></div><!--]-->`);
        } else {
          _push(`<!---->`);
        }
...
//# sourceMappingURL=_trackingNumber_-DzZplAUP.js.map
