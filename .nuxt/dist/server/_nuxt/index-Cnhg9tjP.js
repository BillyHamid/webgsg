...
import { a as _sfc_main$3, _ as _imports_0 } from "./_virtual_public-C0CzJPiQ.js";
import { defineComponent, ref, mergeProps, unref, useSSRContext, withCtx, createVNode, createTextVNode } from "vue";
...
import "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/h3@1.15.11/node_modules/h3/dist/index.mjs";
import "vue-router";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`Nous contacter</a></nav></header><div class="relative tracking-shell grid lg:grid-cols-[1.1fr_1fr] items-center gap-5 pt-14 pb-12 lg:pt-20 lg:pb-20"><div><p class="reveal tracking-kicker text-accent-400 mb-6">Vos proches sont loin. Votre colis, jamais.</p><h1 class="reveal reveal-1 tracking-title font-display">La distance change.<br><span class="text-accent-400">Le lien reste.</span></h1><p class="reveal reveal-2 text-ink-300 text-base leading-relaxed mt-6 max-w-md">Des États-Unis à l’Afrique de l’Ouest, retrouvez chaque étape du voyage de votre colis, en toute simplicité.</p><div id="suivre" class="reveal reveal-3 mt-9 bg-white rounded-2xl p-5 sm:p-6 max-w-lg shadow-xl shadow-black/10"><div class="flex items-center justify-between mb-4"><h2 class="text-sm font-bold text-ink-900">Où en est votre colis ?</h2>`);
      _push(ssrRenderComponent(_component_TrackIcon, {
        name: "ph:package",
        size: "20",
      ...
      _push(`<p class="text-[10px] text-ink-500 mt-3">Votre numéro de suivi figure sur le reçu de votre envoi.</p></div><p class="reveal reveal-4 mt-5 text-[11px] text-ink-300 flex items-center gap-2">`);
      _push(ssrRenderComponent(_component_TrackIcon, {
        name: "ph:lock-key",
        size: "14"
      }, null, _parent));
      _push(`Sans compte · Informations actualisées · Accès gratuit</p></div><div class="reveal reveal-4 hidden lg:block pl-5">`);
      _push(ssrRenderComponent(_component_PremiumRoute, null, null, _parent));
      _push(`</div></div><div class="relative border-t border-white/10"><div class="tracking-shell py-5 flex flex-wrap items-center justify-between gap-4 text-[11px] text-ink-300"><span class="tracking-kicker !text-[9px]">Un réseau, des liens</span><span>États-Unis <span class="text-accent-400 mx-3">↔</span> Afrique de l’Ouest</span><span class="hidden sm:block">Express &amp; Cargo</span></div></div></section><section id="parcours" class="tracking-shell py-16 sm:py-24"><div class="flex flex-col md:flex-row md:items-end justify-between gap-5 mb-10"><div><p class="tracking-kicker text-accent-600 mb-3">Le voyage, en toute clarté</p><h2 class="font-display text-3xl sm:text-4xl font-extrabold tracking-tight text-ink-900">Chaque étape compte.</h2></div><p class="text-sm text-ink-500 max-w-sm leading-relaxed">Du premier enregistrement à la remise du colis, un historique pour savoir où vous en êtes.</p></div><div class="grid sm:grid-cols-3 gap-5"><!--[-->`);
      ...
      _push(`<!--]--></div></div></section><section class="tracking-shell py-16"><div class="rounded-3xl bg-ink-900 p-7 sm:p-12 flex flex-col sm:flex-row justify-between gap-7 sm:items-center"><div><p class="tracking-kicker text-accent-400 mb-3">Nous sommes à vos côtés</p><h2 class="text-white text-2xl font-display font-bold tracking-tight">Une question sur votre envoi ?</h2><p class="text-ink-300 text-sm mt-3">Notre équipe vous accompagne pour la suite du voyage.</p></div><a href="tel:+13473210379" class="shrink-0 flex items-center justify-center gap-3 bg-accent-500 text-ink-900 rounded-xl px-5 h-14 font-bold text-sm hover:bg-accent-400">`);
      _push(ssrRenderComponent(_component_TrackIcon, {
        name: "ph:phone",
        size: "18"
      }, null, _parent));
      _push(`+1 (347) 321-0379</a></div></section><footer class="tracking-shell pb-8 flex flex-wrap gap-3 items-center justify-between text-[11px] text-ink-500"><span>© ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} Global Shipping Group</span><a href="#top" class="hover:text-accent-700">Retour en haut ↑</a></footer></div>`);
    };
  }
});
...
//# sourceMappingURL=index-Cnhg9tjP.js.map
