import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, defineComponent, ref, watch, h, nextTick, provide, isVNode, createCommentVNode, Suspense, Fragment, useSSRContext, unref, mergeProps, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/h3@1.15.11/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { defu, defuFn } from "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/defu@6.1.7/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol } from "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/ufo@1.6.4/node_modules/ufo/dist/index.mjs";
import { klona } from "C:/Users/HP/Documents/mes projets/shipping/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs";
...
const unhead_BSGqn3vPlIUX3aXD1Un2q53WvLSmOpC8fWDWKZhS8ok = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Cnhg9tjP.js")
  },
  {
    name: "p-trackingNumber",
    path: "/p/:trackingNumber()",
    component: () => import("./_nuxt/_trackingNumber_-DzZplAUP.js")
  }
];
...
const revive_payload_server_aoYSilQeFhzLp4xoBanhcietuAscNVGJmAxk2ars1pk = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-CW8yVc11.js").then((r) => r["default"] || r.default || r));
...
const plugin_BEwnOOrtXLgLaEHou7U8fQjgvMqHoMFSDx1zwW3pmos = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
...
const plugins = [
  unhead_BSGqn3vPlIUX3aXD1Un2q53WvLSmOpC8fWDWKZhS8ok,
  plugin,
  revive_payload_server_aoYSilQeFhzLp4xoBanhcietuAscNVGJmAxk2ars1pk,
  components_plugin_z4hgvsiddfKkfXTP6M8M4zG5Cb7sGnDhcryKVM45Di4,
  pwa_icons_plugin_C24GcIKjcI2zsa8A86om0L2LZjx1chWtzYxD11T7Txg,
  plugin_BEwnOOrtXLgLaEHou7U8fQjgvMqHoMFSDx1zwW3pmos
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CQsXEcuf.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Bc9IAypu.js"));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.21.9_@types+node@20.19.41_@vue+compiler-sfc@3.5.40_cac@6.7.14_db0@0.3.4_esbuild@0.28.0_xovonl4gqvoizaxejgdr34iesq/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.21.9_@types+node@20.19.41_@vue+compiler-sfc@3.5.40_cac@6.7.14_db0@0.3.4_esbuild@0.28.0_xovonl4gqvoizaxejgdr34iesq/node_modules/nuxt/dist/app/components/nuxt-root.vue");
