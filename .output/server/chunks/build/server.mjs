import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, ref, shallowRef, watch, hasInjectionContext, inject, getCurrentInstance, h, nextTick, defineAsyncComponent, createApp, provide, shallowReactive, isVNode, createCommentVNode, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, Suspense, Fragment, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'vue';
import { c as createError$1, x as parseURL, j as encodePath, e as decodePath, r as hasProtocol, t as isScriptProtocol, u as joinURL, F as withQuery, v as klona, z as sanitizeStatusCode, l as getContext, h as defuFn, $ as $fetch$1, b as baseURL, d as createHooks, k as executeAsync, g as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Cnhg9tjP.mjs')
  },
  {
    name: "p-trackingNumber",
    path: "/p/:trackingNumber()",
    component: () => import('./_trackingNumber_-DzZplAUP.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-CW8yVc11.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CQsXEcuf.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bc9IAypu.mjs'));
...
export { Icon as I, _export_sfc as _, asyncDataDefaults as a, nuxtLinkDefaults as b, createError as c, useNuxtApp as d, entry_default as default, encodeRoutePath as e, fetchDefaults as f, getIcon as g, useRoute as h, useRouter as i, useRuntimeConfig as j, loadIcon as l, navigateTo as n, resolveRouteObject as r, sanitizeTag as s, tryUseNuxtApp as t, useAppConfig as u };
